  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Divider(),
        const SizedBox(height: 20,),
        Text('Name',style: Styles.textStyle22.copyWith(fontWeight: FontWeight.bold, color: Colors.grey),),
        const EditingFormField(initialVal: 'Marwan Ali',),
        Text('Phone',style: Styles.textStyle22.copyWith(fontWeight: FontWeight.bold, color: Colors.grey),),
